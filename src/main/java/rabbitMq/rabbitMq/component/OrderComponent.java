package rabbitMq.rabbitMq.component;
...
public class OrderComponent {
    ...
    public void receiveMessage2(String msg){
        System.out.println("Queue2 내의 결과 값을 받았습니다. msg =" + msg);
    }
    @RabbitListener(queues = "queue3")
    public void receiveMessage3(String msg){
        System.out.println("Queue3 내의 결과 값을 받았습니다. msg =" + msg);
    }
    @RabbitListener(queues = "queue4")
    public void receiveMessage4(String msg){
        System.out.println("Queue4 내의 결과 값을 받았습니다. msg =" + msg);
    }
    @RabbitListener(queues = "queue5")
    public void receiveMessage5(String msg){
        System.out.println("Queue5 내의 결과 값을 받았습니다. msg =" + msg);
    }
